...
<span class="word-wrap">
  ...
  <br>
    ...
    <br>
   <a href="#about" aria-label="Learn more about Yzabel" class="inline-flex items-center gap-2 font-normal text-lg text-[#4E2C1D] hover:text-[#FF6D29] transition duration-300 ease-in-out">
